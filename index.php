            ...
            <div class="col-md-12"> <br>
                ...
                <table id="PatientTable" class="display table table-striped  table-hover table-responsive table-bordered ">
                    ...
                    <tbody>
                        ...
                        require 'conn.php';
                        $query =
                            'SELECT queue.QDate, queue.QNumber, patient.Pname, gender.genderDescription, patient.Image, queue.QStatus 
                        ...
                        foreach ($result as $r) { ?>
                            <tr>
                                ...
                                <td><img src="./picture/" width="50px" height="50" alt="image" onclick="enlargeImg()" id="img1"></td>
                                <td>
                                    <?= $r['Image'] ?>
                                </td>
                                <td><a href="updateQueueForm.php?pid=<?= $r['Pname'] ?>" class="btn btn-warning btn-sm">แก้ไข</a></td>
                                <td><a href="DeleteQueue.php?pid=<?= $r['Pname'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('ยืนยันการลบข้อมูล !!');">ลบ</a></td>
